...
public class UserController {
    ...
    public void pane1(){
        ...
        scrollPane1.setPrefSize(460, 415);
        VBox vbox1 = new VBox();
        VBox vbox2 = new VBox();
    ...
    public void pane2(){
        ...
        buttonAssign.setStyle("-fx-background-color: #009FDA; -fx-text-fill: #FFF; -fx-font-size: 16px; -fx-font-weight: 700; -fx-background-radius: 8px;");
